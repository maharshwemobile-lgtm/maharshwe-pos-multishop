...
function descriptor(method, pathname) {
  const rules = [
    ...
    [/^\/api\/biller-transactions\/sold$/, 'BILLER_SOLD', 'biller_transaction', 'Sold Eload or a bill'],
    [/^\/api\/biller-transactions\/refill$/, 'BILLER_REFILL', 'biller_transaction', 'Refilled Eload balance'],
    [/^\/api\/biller-transactions\/opening$/, 'BILLER_OPENING', 'biller_transaction', 'Set an Eload opening balance'],
    [/^\/api\/biller-transactions\/adjustment$/, 'BILLER_ADJUSTMENT', 'biller_transaction', 'Adjusted an Eload balance'],
    [/^\/api\/biller-transactions\/[^/]+\/void$/, 'BILLER_VOIDED', 'biller_transaction', 'Voided an Eload record'],
    [/^\/api\/billers$/, 'BILLER_CREATED', 'biller', 'Added a biller account'],
    [/^\/api\/money-service\/transactions\/[^/]+\/collect$/, 'MONEY_SERVICE_COLLECTED', 'money_service', 'Collected a money transfer'],
    [/^\/api\/money-service\/transactions\/[^/]+\/void$/, 'MONEY_SERVICE_VOIDED', 'money_service', 'Voided a money transfer'],
    [/^\/api\/money-service\/transactions$/, 'MONEY_SERVICE_CREATED', 'money_service', 'Recorded a money transfer'],
