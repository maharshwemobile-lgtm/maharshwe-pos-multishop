...
export default function EcommerceCenter() {
  ...
  async function setSelectedOnline(visible) {
    ...
    if (visible && selected.some((product) => !product.ecommerceImages?.length)) return setMessage('Photo မရှိသော Product ကို Publish Online လုပ်၍မရပါ။ Photo အရင်တင်ပါ။');
    setBusy(true); setMessage('');
