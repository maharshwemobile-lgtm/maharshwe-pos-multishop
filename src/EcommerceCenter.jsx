...
export default function EcommerceCenter() {
  ...
  const [filters, setFilters] = useState({ publicationStatus: 'ONLINE', brand: '', categoryId: '', stockLevel: '' });
